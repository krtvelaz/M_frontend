    ...
    <div className="row">
      ...
      <div className="my-3 ant-collapse-icon-position-end">
        ...
        >
          ...
          <Panel showArrow={false} header="¿Me puedo postular a más de un reto?" key="2">
            <p>
              {" "}
          ...
          <Panel showArrow={false} header="¿Cuándo y dónde informarán los postulados seleccionados?" key="3">
            <p>
              {" "}
          ...
          <Panel showArrow={false} header="¿Cómo puedo contactar al equipo de la convocatoria para recibir atención?" key="4">
            <p >
          ...
          <Panel showArrow={false} header="¿Cuantas propuestas se van a seleccionar?" key="5">
            <p >
          ...
          <Panel showArrow={false} header="¿Cómo serán seleccionados los ganadores?" key="6">
            <p >
