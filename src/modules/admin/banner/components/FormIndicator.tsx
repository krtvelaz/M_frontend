        ...
        return (
          <Form>
            ...
            <div className="row ">
              ...
              <div className="col-12 col-md-12  col-lg-6  ">
                <label
                  htmlFor="est_descripcion_persona_impacto_id"
                  className="form-label"
                >
                  Descripción
                </label>
            ...
            <div className="row ">
              <div className="col-12 col-md-12  col-lg-6  ">
                <label
                  htmlFor="est_actores_conectados_id"
                  className="form-label"
                >
              ...
              <div className="col-12 col-md-12  col-lg-6  ">
                <label
                  htmlFor="est_descripcion_actores_conectados_id"
                  className="form-label"
                >
                  Descripción
                </label>
            ...
            <div className="row ">
              <div className="col-12 col-md-12  col-lg-6  ">
                <label
                  htmlFor="est_solucion_implementada_id"
                  className="form-label"
                >
              ...
              <div className="col-12 col-md-12  col-lg-6  ">
                <label
                  htmlFor="est_descripcion_solucion_implementada_id"
                  className="form-label"
                >
                  Descripción
                </label>
