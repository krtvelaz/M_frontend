...
import { default_gallery, default_list_gallery, fail_gallery, fail_list_gallery, success_gallery, success_list_gallery } from "../slice";

export const create_gallery = (id_publication: number, values: IGalleryInfo) => { //
  ...
  export const get_gallery_by_id = (id: number) => {
    return async (dispatch: any) => {
      ...
      try {
        ...
        dispatch(success_gallery(res.data.body));
